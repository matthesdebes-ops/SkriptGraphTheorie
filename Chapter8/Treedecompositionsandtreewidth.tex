...
\begin{remark}\label{8.12}
    \begin{itemize}
        ...
        \item Courcelle's theorem states that every graph problem expressible in MSO (Monadic Second Order Logic) can be solved in linear time on a graphclass of bounded treewidth.   
    \end{itemize}
\end{remark}
