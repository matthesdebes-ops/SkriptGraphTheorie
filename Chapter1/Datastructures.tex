...
\begin{definition}\label{1.18}
    The \textbf{adjacency matrix}\index{adjacency matrix} of $G$ is the matrix $A=(a_{ij})$ with $a_{ij}=\begin{cases}
            1 & \{i,j\}\in E \\
            0 & else
            \end{cases}$\\
    The \textbf{adjacency list}\index{adjacency list} of $G$ stores a label for each vertex, and a list of (pointers to) its neighbours.
\end{definition}
