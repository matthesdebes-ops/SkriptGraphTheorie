...
\end{center}
\par
        Claim: $E(T)=E$. Assume otherwise. Consider $e\in E\backslash E(1)$ and write $e=\{v_k,v_l\}$. Then $(v_k,e_{k+1},v_{k+1},...,v_{m-1},e_m,v_0,e_1,v_1,...,e_k,v_k,e,v_l)$ is a longer trail $\lightning$ 
    \end{enumerate}
\end{proof}
\vspace{0.5cm}
