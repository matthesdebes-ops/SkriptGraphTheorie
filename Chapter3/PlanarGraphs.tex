...
\begin{definition}\label{3.1}
    A \textbf{planar drawing}\index{planar drawing} of a graph $G$ consists of injective continuous functions 
    \begin{align*}
...
\begin{definition}\label{3.11}
    ...
    A graph $G'$ is a \textbf{minor}\index{minor} of $G$ if $G'$ can be obtained from $G$ by a sequence of vertex deletions, edge deletions and edge contractions.
\end{definition}
